...
install_pacman_packages() {
    ...
    sudo pacman -S $CONFIRM_FLAG hyprland iwd foot thunar brightnessctl wireplumber polkit-gnome xdg-desktop-portal-hyprland qt6ct qt5ct blueman geoclue btop starship fish gvfs nss
