    ...
    return (
        ...
        >
            <Gtk.EventControllerKey 
                $={(self) => self.connect("key-pressed", (_e, keyval) => {
            ...
            >
                ...
                >
                    <Gtk.Box orientation={Gtk.Orientation.VERTICAL} name="results-container">
                        <Gtk.Separator />
                                ...
                                {(app) => (
                                    ...
                                    >
                                        <Gtk.Box name="app-item-content">
                                            <Gtk.Image iconName={app.iconName || "system-run-symbolic"} />
